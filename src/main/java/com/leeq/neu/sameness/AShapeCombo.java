...
class Rect extends AShape {
  ...
  public boolean sameRect(Rect that) {
     ...
     */
    return this.loc.samePoint(that.loc) &&
  ...
  // does this shape (including the boundary) contain the given point?
  public boolean contains(CartPt pt) {
    return (this.loc.x <= pt.x) && (pt.x <= this.loc.x + this.width) && (this.loc.y <= pt.y) && (pt.y <= this.loc.y + this.height);
  }
}
...
class Square extends Rect {
  ...
  public boolean sameSquare(Square that) {
    return this.loc.samePoint(that.loc) &&
        this.width == that.width; // No need to check the h field, too...
  }
}
...
//    return t.checkInexact(this.pt1.distTo0(), 0.0, 0.001) && t.checkInexact(this.pt2.distTo0(), 5.0, 0.001);
//  }
//
//  // test the method distTo in the class CartPt
//  boolean testDistTo(Tester t) {
//    return t.checkInexact(this.pt1.distTo(this.pt2), 5.0, 0.001) && t.checkInexact(this.pt2.distTo(this.pt3), 5.0, 0.001);
//  }
//
//  // test the method area in the shape classes
//  boolean testShapeArea(Tester t) {
//    return t.checkInexact(this.c1.area(), 314.15, 0.01) && t.checkInexact(this.s1.area(), 900.0, 0.01) && t.checkInexact(this.r1.area(), 600.0, 0.01) && t.checkInexact(this.cb1.area(), 914.15926, 0.01) && t.checkInexact(this.cb2.area(), 2200.0, 0.01) && t.checkInexact(this.cb3.area(), 3114.15926, 0.01);
//  }
//
//  // test the method distTo0 in the shape classes
//  boolean testShapeDistTo0(Tester t) {
//    return t.checkInexact(this.c1.distTo0(), 60.71, 0.01) && t.checkInexact(this.c3.distTo0(), 74.40, 0.01) && t.checkInexact(this.s1.distTo0(), 70.71, 0.01) && t.checkInexact(this.s3.distTo0(), 44.72, 0.01) && t.checkInexact(this.r1.distTo0(), 70.71, 0.01) && t.checkInexact(this.r3.distTo0(), 44.72, 0.01) && t.checkInexact(this.cb1.distTo0(), 60.71, 0.01) && t.checkInexact(this.cb2.distTo0(), 44.72, 0.01) && t.checkInexact(this.cb3.distTo0(), 44.72, 0.01);
//  }
//
//  // test the method grow in the shape classes
//  boolean testShapeGrow(Tester t) {
//    return t.checkExpect(this.c1.grow(20), this.c2) && t.checkExpect(this.s1.grow(20), this.s2) && t.checkExpect(this.r1.grow(20), this.r2) && t.checkExpect(this.cb1.grow(20), new Combo(this.r2, this.c2));
//  }
//
//  // test the method biggerThan in the shape classes
//  boolean testShapeBiggerThan(Tester t) {
//    return t.checkExpect(this.c1.biggerThan(this.c2), false) && t.checkExpect(this.c2.biggerThan(this.c1), true) && t.checkExpect(this.c1.biggerThan(this.s1), false) && t.checkExpect(this.c1.biggerThan(this.s3), true) && t.checkExpect(this.c1.biggerThan(this.cb1), false) &&
//
//        t.checkExpect(this.s1.biggerThan(this.s2), false) && t.checkExpect(this.s2.biggerThan(this.s1), true) && t.checkExpect(this.s1.biggerThan(this.c1), true) && t.checkExpect(this.s3.biggerThan(this.c1), false) && t.checkExpect(this.s2.biggerThan(this.cb1), true) &&
//
//        t.checkExpect(this.r1.biggerThan(this.r2), false) && t.checkExpect(this.r2.biggerThan(this.r1), true) && t.checkExpect(this.r1.biggerThan(this.c1), true) && t.checkExpect(this.r3.biggerThan(this.s1), false) && t.checkExpect(this.r2.biggerThan(this.cb1), true) && t.checkExpect(this.r3.biggerThan(this.cb1), false) &&
//
//        t.checkExpect(this.cb2.biggerThan(this.r1), true) && t.checkExpect(this.cb1.biggerThan(this.r2), false) && t.checkExpect(this.cb1.biggerThan(this.c1), true) && t.checkExpect(this.cb1.biggerThan(this.c3), false) && t.checkExpect(this.cb1.biggerThan(this.s2), false) && t.checkExpect(this.cb2.biggerThan(this.s1), true) && t.checkExpect(this.cb1.biggerThan(this.cb3), false) && t.checkExpect(this.cb2.biggerThan(this.cb1), true);
//  }
//
//  // test the method contains in the shape classes
//  boolean testShapeContains(Tester t) {
//    return t.checkExpect(this.c1.contains(new CartPt(100, 100)), false) && t.checkExpect(this.c2.contains(new CartPt(40, 60)), true) && t.checkExpect(this.s1.contains(new CartPt(100, 100)), false) && t.checkExpect(this.s2.contains(new CartPt(55, 60)), true) && t.checkExpect(this.r1.contains(new CartPt(100, 100)), false) && t.checkExpect(this.r2.contains(new CartPt(55, 60)), true) && t.checkExpect(this.cb1.contains(new CartPt(100, 100)), false) && t.checkExpect(this.cb2.contains(new CartPt(55, 60)), true);
//  }
